...
\begin{figure}[H]
  ...
  % TODO: fazer diagrama certo ou mudar o nome
...
codificada com o \textit{Protobuf}~\cite{protobufdocs}, uma biblioteca bem
...
As mensagens são transmitidas num socket ZMQ (\textit{ZeroMQ}~\cite{zmqdocs},
