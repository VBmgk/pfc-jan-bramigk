...
% TODO: Incluir imagem padroes_ssl
%\begin{figure}[thpb]
%  \centering
%  \includegraphics[width=20cm]{img/padroes_ssl}
%  \caption{Padrões oficiais da SSL}\label{padroes_ssl}
%\end{figure}
...
% TODO: Incluir imagens cmra_campo e rob_data
%\begin{figure}[thpb]
%  \centering
%  \includegraphics[width=20cm]{img/rob_data}
%  \caption{Parâmetros de estádo mutáveis do robô (vide 
%           definição~\ref{def:corpo_rigido})}\label{rob_data}
%  \includegraphics[width=20cm]{img/cmra_campo}
%  \caption{Disposição das câmeras no campo}\label{cmra_campo}
%\end{figure}
