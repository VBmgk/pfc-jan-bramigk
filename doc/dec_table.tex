...
decisões $a_{anterior} \in A_c$ de todos os robôs de $T_c$.
Isso é incorporado na próxima rodada do algorítmo,
...
antes dos robôs em $Rob_{ad}$, o cálculo do receptor $r_j$ é
