...
de todos os robôs de $T_c$.  Isso é incorporado na próxima rodada do algorítmo,
conforme ilustrado na Figura~\ref{fig:estr_busca}.


Devido a movimentação dos robôs em $Rob_{ad}$, somente as ações $Mover(r_i)$ e
$Chutar(r_{com{\ }bola})$ são guardadas intergralmente. No caso da ação
...
Caso a posse de pola passe para o time adversário, o robô que possuia a bola
