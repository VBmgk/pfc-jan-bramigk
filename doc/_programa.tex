...
aquisição dos dados da visão, planejamento e transmissão dos comandos aos robôs.
...
estado do tabuleiro}, label={alg:minimax_req_proto}]{proto/update.proto}
...
Há também uma \textit{skill} para redirecionar a partir de um joystick tal que
