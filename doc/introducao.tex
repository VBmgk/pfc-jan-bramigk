...
totalmente autô- nomos capazes de derrotar a equipe campeã mundial de futebol
...
regras da SSL, as equipes devem ser compostas por 6 robôs, sendo um deles o
...
equipes utiliza a visão centralizada. A figura 1 mostra uma imagem da SSL
Robocup 2013, da qual a RoboIME (Equipe de Futebol de Robôs do Laboratório de
...
modelagem heurística limita o número de jogadas que se pode executar e limita a
capacidade que o computador tem de testar um grande número de possibilidades.

\section{Objetivo}
% TODO: explorar mais os objetivos secundários

Implementação de uma arquitetura de controle com um modelo discreto e sequencial
da RoboCup Small Size League.
...
heuristicamente. Com tal mecanismo é possível melhorar a IA em uso pela RoboIME
...
\section{Metodologia}
% TODO: escrever metodologia

\section{Estrutura}
% TODO: escrever estrutura
