...
Inicialmente a arquitetura do futebol de robôs considerada neste trabalho é
detalhada, juntamente com definições de termos relevantes para este trabalho.

A seguir, a teoria sobre jogos será revisada. São apresentados também
...
No capítulo~\ref{cap:minimax}, a arquitetura do futebol de robôs considerada é
detalhada. A seguir são apresentadas definições de conceitos utilizados ao
longo do trabalho. Posteriormente, a teoria dos jogos é revisada.

No capítulo~\ref{cap:licoes_aprendidas} e são apresentados
alguns dados empíricos observados anteriormente.
