...
% FIXME: Este parágrafo está mau escrito. Elaboar melhor as idéias. Descrever o
%        futebol de robôs brevemente.
Cada vez mais a robótica tem feito parte da sociedade atual. Um dos problemas
atuas da robótica é o planejamento em ambientes multiagentes dinâmicos e
competitivos. Um exemplo um problema dessa classe é um jogo de futebol de robôs,
onde um grupo de robôs é controlado por uma IA independente.
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\linewidth]{arquitetura_ssl}
...
% FIXME: definir brevemente o minimax... CHECK
...
% XXX: Acho que este deve ser mesmo mo objetivo.  ESTA SEÇÃO ESTÁ CONFUSA
