...
DEF_CONST(bool, CONSTANT_RATE, true);
DEF_CONST(bool, KICK_IF_NO_PASS, false);
DEF_CONST(int, DECISION_RATE, 7);
DEF_CONST(int, RAMIFICATION_NUMBER, 5000);
DEF_CONST(int, FULL_CHANGE_PERCENTAGE, 100);
DEF_CONST(int, MAX_DEPTH, 0);
DEF_CONST(float, KICK_POS_VARIATION, 0.150);
DEF_CONST(float, MIN_GAP_TO_KICK, 9.0);
DEF_CONST(float, WEIGHT_MOVE_DIST_MAX, 0);
DEF_CONST(float, WEIGHT_MOVE_DIST_TOTAL, 0);
...
DEF_CONST(float, WEIGHT_ENEMY_RECEIVERS_NUM, 20);
