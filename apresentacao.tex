...
\frame{%
  ...
  \begin{figure}
    \centering
    \includegraphics[width= 0.3\linewidth]{communication}
    \includegraphics[width= 0.6\linewidth]{threads}
  ...
  \begin{block}{}
    ...
    \begin{itemize}
      ...
      \item A ferramenta criada atingiu os objetivos desejados, modificando o
            ...
            função objetivo
      \item Foi desenvolvida com sucesso uma interface gráfica que permite
            modificar esses parâmetros em tempo de execução.
    \end{itemize}
  \end{block}
}
