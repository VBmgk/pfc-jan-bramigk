...
\frame{%
  ...
  \begin{block}{}
    \centering
    \begin{itemize}
      \item Comunicação via rede para processamento dedicado
...
\frame{%
  ...
  \begin{block}
    ...
    \begin{itemize}
      \item Ajuste da função de avaliação
      \item Implementação da memória do planejamento anterior
      \item Automatização partidas contra a inteligência heurística
    \end{itemize}
  \end{block}
}
